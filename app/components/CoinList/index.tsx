...
type CoinListProps = {
  ...
  setCoinId: (coinId: string | undefined) => void;
};

export function CoinList({ setActiveTab, coinId, setCoinId }: CoinListProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {coinId && <TradePanel close={() => setCoinId(undefined)} />}
